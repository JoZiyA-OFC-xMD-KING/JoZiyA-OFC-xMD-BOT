...
let setting = `
*╭──────────────●●►*
 *Jᴏᴢɪʏᴀ Oꜰᴄ Xᴍᴅ Sᴛᴛɪɴɢꜱ* ⚙️
*╰──────────────●●►*
*╭───────────────────●●►*
*│◈ ALIVE_IMG:* .update ALIVE_IMG: catbox 
...
let repo =`
*╭──────────────●●►*
*| 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁:* 94766002356 
*| 𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳 𝚁𝙴𝙿𝙾:* https://github.com/JoZiyA-OFC-xMD-KING/JoZiyA-OFC-xMD-BOT
*| 𝙱𝙾𝚃 𝚄𝙿𝙳𝙴𝚃𝙰 𝙽𝙴𝚆𝚂 :* https://whatsapp.com/channel/0029VbBBr1iElagw9wIc9K3M
*╰──────────────●●►*
`
const ownerdata = (await axios.get('https://raw.githubusercontent.com/athulakumara604/ASITHA-MD-DATABASE/refs/heads/main/ditels/ditels.json')).data
            let LOGO = ownerdata.imageurl;
