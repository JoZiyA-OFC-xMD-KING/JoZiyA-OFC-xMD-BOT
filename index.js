...
const ownerNumber = ['94766002356']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/session/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.split("JoZiyA-OFC-xMD=")[1];
...
console.log("Connecting JoZiyA-OFC-xMD 🧬...");
...
await conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://files.catbox.moe/96u4ui.jpg` }, caption: up })
    ...
    conn.sendButtonMessage = async (jid, buttons, quoted, opts = {}) => {
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                      ...
                      newsletterName: "Rᴀᴍᴇꜱʜ Sᴀᴍᴘᴀᴛʜ ࿐",
                      serverMessageId: 1
                    },
                    externalAdReply: { 
    title: '乡Rᴀᴍᴇꜱʜ Sᴀᴍᴘᴀᴛʜ ࿐',
    body: 'Pᴏᴡᴇʀᴅ Bʏ Rᴀᴍᴇꜱʜ Sᴀᴍᴘᴀᴛʜ',
    mediaType: 1,
    sourceUrl: "https://wa.me/94766002356",
...
if(senderNumber.includes("94766002356")){
if(isReact) return
m.react("🧑‍💻")
}
if(senderNumber.includes("94723369091")){
if(isReact) return
m.react("👾")
}
//read commands
...
const isCreator = ["94742539703,94766002356"]
      .map((v) => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net")
      .includes(sender)    
...
if ( isCmd && isBanUser ) return reply("❌ *You are banned from using Commands.....*\n\n*_Please contact JoZiyA-OFC-xMD Bot Owner <94766002356> Remove your Ban_* 👨‍🔧\n")
//=====================================================================================
    //==================================plugin map================================
...
await conn.sendMessage(from, { text: "❌ ```Another Bot's message Detected :``` 📚 *Removed By JoZiyA-OFC-xMD* ❗\nAnti Bot System on..." })
if ( config.ANTI_BOT == "true" && isBotAdmins ) {
await conn.sendMessage(from, { delete: mek.key })
await conn.groupParticipantsUpdate(from,[sender], 'remove')
  }}
    if ( mek.id.startsWith("QUEENAMDI") ) {
await conn.sendMessage(from, { text: "❌ ```Another Bot's message Detected :``` *🙈 JoZiyA-OFC-xMD* ❗\n*Removed By JoZiyA-OFC-xMD* ❗\nAnti Bot System on..." })
if ( config.ANTI_BOT == "true" && isBotAdmins ) {
await conn.sendMessage(from, { delete: mek.key })
await conn.groupParticipantsUpdate(from,[sender], 'remove')
  }}
